...
import { Columns, LayoutList, ListOrdered, Hash, AlertCircle } from 'lucide-react';
import { clsx } from 'clsx';
import { ComparisonResult, DiffLine, getIntraLineDiff } from '../utils/diff';
...
const LineContent = ({ line, mate, mode, type }: { line: DiffLine, mate?: DiffLine, mode: any, type?: any }) => {
...
export const DiffView = ({ comparison, loading }: DiffViewProps) => {
